...
from MLModularcodingProject.config.configuration import *
import os, sys
import pandas as pd
...
class DataIngestion:
    ...
    def initiate_data_ingestion(self):
        try:
            ...
            #df = pd.read_csv(os.path.join('C:\Users\venky\Desktop\SkillSplash\Project_template\MLModularcodingProject\Data\finalTrain.csv'))
